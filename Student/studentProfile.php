...
<div class="col-sm-6 mt-5 mx-5">
    <form class="" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="stuId">Studen ID</label>
            <input type="text" class="form-control" id="stuId" name="stuId" value="<?php if (isset($stuId)) {
                echo "$stuId";
            } ?>" readonly>
        </div>
        <!-- <div class="mb-3">
            <label for="stuEmail">Course Description</label>
            <textarea class="form-control" id="stuEmail" name="stuEmail" rows="2"></textarea> 
        </div> -->
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="stuImg">Uplode Image</label>
