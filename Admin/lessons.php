...
<form action="" class="mt-3 form-inline d-print-none">
   <div class="mb-3 me-3">
    ...
    <input type="text" class=" form-control ms-3" id="checkid" name="checkid">
   </div> 
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <tbody>
            ...
            while($row = $result->fetch_assoc() ){              
                ...
                echo '<div class="alert alert-dark mt-4" role="alert">Course Not Course!</div>';
        }
...
if(isset($_SESSION['course_id'])){
    echo '<div><a href="./addLesson.php" class="btn btn-danger box"><i class="fas fa-plus fa-2x"></i></a></div>';
}
